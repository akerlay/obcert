...
1. Build Release and launch `obcert.app`.
...
6. Click **Удалить всё** — banner returns to "Защита выключена"; in Firefox, Preferences → Privacy & Security → Certificates → View Certificates → Authorities, the "obcert Local Constrained Root" is gone.
